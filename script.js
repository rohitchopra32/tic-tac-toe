		...
		function Move(c)
		{
			...
			if(whose_move == 1)
			{
				...
				if(ok == 1)
				{
					document.getElementById(c).src = "https://s32.postimg.org/azmcp4urp/image.jpg";
					whose_move = 2;
					process();
				}
				else
			...
			else 
			{
				...
				if(ok == 1)
				{
					document.getElementById(c).src = "https://s32.postimg.org/fmseqwi4l/image.jpg";
					whose_move = 1;
					process();
				}
				else 
		...
		function playAgain()
		{
			...
			document.getElementById('A').src = "https://s32.postimg.org/lmb3xfwlh/blank.jpg";
			document.getElementById('B').src = "https://s32.postimg.org/lmb3xfwlh/blank.jpg";
			document.getElementById('C').src = "https://s32.postimg.org/lmb3xfwlh/blank.jpg";
			document.getElementById('D').src = "https://s32.postimg.org/lmb3xfwlh/blank.jpg";
			document.getElementById('E').src = "https://s32.postimg.org/lmb3xfwlh/blank.jpg";
			document.getElementById('F').src = "https://s32.postimg.org/lmb3xfwlh/blank.jpg";
			document.getElementById('G').src = "https://s32.postimg.org/lmb3xfwlh/blank.jpg";
			document.getElementById('H').src = "https://s32.postimg.org/lmb3xfwlh/blank.jpg";
			document.getElementById('I').src = "https://s32.postimg.org/lmb3xfwlh/blank.jpg";
